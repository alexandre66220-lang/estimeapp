...
export default function Nav() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-dust/90 backdrop-blur-sm border-b border-dusk/8">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8" aria-label="Navigation principale">
          <a
            ...
            className="text-sm font-medium text-dusk/70 hover:text-dusk transition-colors duration-200"
          >
            Comment ça marche
          </a>
          <a
